 ...
 * Date  : 11th July 2004
 * File  : upgrade201to202.php
 * This is a utility for upgrading the database from version 2.01
 * to version 2.02
 *
 ...
 *********************************************************/
  ...
  // Add INCORR_SCORE
  setValueIfNotExists('INCORR_RESULT',"insert into $dbaseConfigData (lid,param,value,descr) values ('$leagueID','INCORR_RESULT','$incorrResult','The number of points awarded for predicting an incorrect result')");
  // Rem CORR_MARGIN
  runQuery("ALTER TABLE $dbaseUserData ADD COLUMN showstandings enum('Y','N') default 'N'");

   // Add the current version to the config table
  runQuery("update $dbaseConfigData set value='2.02' where lid='$leagueID' and param='VERSION'");
   
  echo "The tables have been updated to version 2.02. Check your configuration values as some may have changed. For security purposes remove this file from your server!!!!!<br>";
