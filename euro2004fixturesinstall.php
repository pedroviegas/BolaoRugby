...
// Knockout stages
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (25,'Winner Group A','Runner Up Group B','20040624 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (26,'Winner Group B','Runner Up Group A','20040625 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (27,'Winner Group C','Runner Up Group D','20040626 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (28,'Winner Group D','Runner Up Group C','20040627 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (29,'WIN25','WIN27','20040630 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (30,'WIN26','WIN28','20040701 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
$query = "insert into $dbaseMatchData (matchid, hometeam, awayteam, matchdate) values (31,'WIN29','WIN30','20040704 19:45:00')";
mysql_query($query) or die ("Dead : $query.".mysql_error());
    ...
    <table>
      ...
      <tr>
        ...
        <td class="CENTERCOL" colspan="3" align="CENTER">
          <font class="TBLROW">
The fixtures have been inserted. double check the kickoff times are they should be stored in server time. The kickopff time will appear on the fixtures pages with the correct time zone.
          </font>
        </td>
      </tr>
    </table>
